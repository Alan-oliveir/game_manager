...
use crate::constants::{CONFIG_KEY_LANGUAGE, CONFIG_KEY_REGION, DEFAULT_LANGUAGE, SUPPORTED_LANGUAGES};
...
// === IDIOMA (usado como target de tradução, ex: ai_translation.rs) ===
