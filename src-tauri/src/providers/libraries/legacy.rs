...
/// # Exemplos
/// ```rust
/// # use game_manager_lib::providers::libraries::legacy::normalize_game_name;
...
/// # Exemplo
/// ```rust,no_run
/// # use game_manager_lib::providers::libraries::legacy::LegacySource;
...
#[async_trait]
impl crate::providers::libraries::providers::GameSource for LegacySource {
