            ...
            <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto p-0 gap-0 border-none bg-card">
                ...
                <div className="relative h-48 w-full overflow-hidden bg-muted">
                    ...
                    <div className="absolute bottom-4 left-6 z-10 flex items-end gap-4">
                        {/* Capa Principal */}
                        <div
                            className="w-32 h-48 bg-background rounded-lg shadow-2xl overflow-hidden border-4 border-card translate-y-12">
                            {game.cover_url ? (
                        ...
                        <div className="mb-2">
                            <h2 className="text-3xl font-bold text-foreground drop-shadow-md">{game.name}</h2>
                ...
                <div className="pt-16 px-6 pb-8 grid md:grid-cols-3 gap-8">
                        ...
                        <div className="bg-muted/30 p-4 rounded-xl space-y-4 border border-border">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-1">
                                    <span className="text-xs text-muted-foreground">Tempo Jogado</span>
                  ...
                  <span className={`text-xl font-bold px-3 py-1 rounded border ${
                      details.metacritic >= 75 ? "border-green-500 text-green-500 bg-green-500/10" :
                          details.metacritic >= 50 ? "border-yellow-500 text-yellow-500 bg-yellow-500/10" :
                    ...
                    {details.metacritic}
                        ...
                        <div className="space-y-2">
                            ...
                            {loading ? (
                                ...
                                <p className="text-muted-foreground italic">Não foi possível carregar detalhes
                                    online.</p>
                            )}
                        </div>
                        ...
                        {details?.tags && details.tags.length > 0 && (
                            <div className="space-y-2">
                                <h4 className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">Tags
                                    Populares</h4>
                                <div className="flex flex-wrap gap-2">
