...
export default function Header({
    ...
    return (
        <header
            className="h-16 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b border-border flex items-center justify-between px-6 gap-4 sticky top-0 z-50">
            {/* Search Bar */}
