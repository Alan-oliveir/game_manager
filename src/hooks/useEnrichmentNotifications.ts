 ...
 * (`enrich_newly_imported`, com `platform` preenchido) quanto pelas varreduras gerais da biblioteca (`update_metadata`,
 * `fill_missing_metadata`, com `platform: null`). Montado uma vez no nível raiz do app.
 */
