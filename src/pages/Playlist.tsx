...
export default function Playlist({ allGames, onGameClick, profileCache }: PlaylistProps) {
    const {
        playlistGames,
        addToPlaylist,
        removeFromPlaylist,
        ...
        <div className="flex flex-col lg:flex-row h-full overflow-hidden bg-background">
                    ...
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground text-sm">
                                Organize sua próxima aventura. {playlistGames.length} jogos na fila.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex-1 overflow-y-auto px-8 pt-6 pb-4 custom-scrollbar">
                    {playlistGames.length > 0 ? (
                        ...
                        <div className="flex flex-col items-center justify-center h-full text-muted-foreground opacity-60">
                            ...
                            <p className="text-sm">Adicione jogos da biblioteca ou das sugestões.</p>
                        </div>
                    )}
                </div>
            </div>
            ...
            <div className="w-full lg:w-[450px] shrink-0 bg-muted/10 flex flex-col border-l border-border backdrop-blur-sm">
                <div className="p-6 shrink-0 border-b border-border/40 bg-muted/20">
                    ...
                    <p className="text-xs text-muted-foreground">Baseado no que você gosta de jogar.</p>
                </div>
                ...
                <div className="flex-1 overflow-y-auto p-6 custom-scrollbar">
                            ...
                            <div key={game.id} className="relative group">
                                <StandardGameCard
                                    ...
                                    actions={
                                        ...
                                        >
                                            <PlusCircle size={14} /> <span className="text-xs font-bold">Add</span>
                                        </Button>
                                    }
                                    onClick={() => onGameClick(game)}
                                />
                    ...
                    {suggestions.length === 0 && (
                        <div className="text-center py-10 space-y-2">
                            <p className="text-sm text-muted-foreground">Sem sugestões novas.</p>
