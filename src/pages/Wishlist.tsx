...
import {DollarSign, ExternalLink, Loader2, ShoppingCart, Trash2} from "lucide-react";
    ...
    if (games.length === 0) {
        return (
            <div className="flex-1 flex flex-col items-center justify-center text-muted-foreground">
                ...
                <p className="text-sm">Vá para a aba "Em Alta" para descobrir novos jogos.</p>
            </div>
        );
    }
                        ...
                        <div className="p-4 flex flex-col flex-1">
                            ...
                            <div className="mt-auto flex items-center justify-between gap-2">
                                ...
                                <div className="text-sm font-medium">
                                    {game.current_price ? (
                                        <span className="text-green-500">R$ {game.current_price.toFixed(2)}</span>
                                    ) : (
                                ...
                                <Button size="sm" variant="outline" className="h-8 gap-2" disabled={!game.store_url}>
