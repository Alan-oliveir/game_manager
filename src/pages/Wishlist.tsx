import {ExternalLink, Loader2, Plus, RefreshCw, ShoppingCart, Trash2,} from "lucide-react";
...
export default function Wishlist() {
    const {games, isLoading, isRefreshing, removeGame, refreshPrices, refreshList} =
        useWishlist();
